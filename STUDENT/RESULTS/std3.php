...
if(is_array($results)){
 $_SESSION['jumlaaaa'] = count($results);
  $count = 0;
...
echo'
<div>
<input id="update_results" type="submit" name="update_results" style="display:none;">
</div>
</form>
</table>
<label id="lebo" for="update_results" style="width:100px;margin-left:6px;padding:10px 10px;border-radius:10px;cursor:pointer;background-color:darkgreen;color:white;float:left;">UPDATE</label>
<form>
